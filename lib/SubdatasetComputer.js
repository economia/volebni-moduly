      ...
      this.dataset.forEach(function(county){
        ...
        parties.forEach(function(party){
          ...
          candidates.forEach(function(candidate){
            var name, surname, partyId, rank, votedRank, mandate, newLength;
            name = candidate.name, surname = candidate.surname, partyId = candidate.partyId, rank = candidate.rank, votedRank = candidate.votedRank, mandate = candidate.mandate;
            if (!mandate) {
              return;
            }
