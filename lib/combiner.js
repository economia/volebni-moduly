...
(function(){
  ...
  mandaty = require('./mandaty-po-kraji');
  prefhlasy = require('./preferencni-hlasy');
  dhondt = require('./dhondt');
  module.exports.combine = function(counties, parties, candidates){
    var parties_assoc, county_party_candidates_assoc;
    parties_assoc = {};
    parties.forEach(function(it){
      return parties_assoc[it.id] = import$({}, it);
    });
